...
a=b.extend({url:ltoptions.url+"/admin/login/?backurl="+encodeURIComponent(location.href),calback:!1,email:function(){f.location=a.url}},a);var c=this;c.ready(function(){c.dialog=!0;var d=lang.ulogin,e=c.html.replace(/%%lang.emaillogin%%/gim,d.emaillogin).replace(/%%lang.subtitle%%/gim,d.subtitle).replace(/%%url%%/gim,a.url);b.isFunction(a.callback)?(e=e.replace(/%%callback%%/gim,"callback=ulogincallback").replace(/%%redirurl%%/gim,""),f.ulogincallback=function(c){b.closedialog();try{a.callback(c),
...
!0;b.isFunction(calback)&&c()},error:function(b,f){d.logon(a,c)}});litepubl.stat("ulogin_checklogged");return!1}})})(jQuery,document,window);
