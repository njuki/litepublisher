...
(litepubl.emailauth=new litepubl.Emailauth);litepubl.emailauth.open(d)});return!1});litepubl.stat("ulogin_open")},buttons:[{title:lang.dialog.close,click:b.closedialog}]})})},ready:function(a){return this.script?this.script.done(a):this.script=b.load_script("//ulogin.ru/js/ulogin.js",a)},auth:function(a,c,d){var e=this;return b.jsonrpc({method:"ulogin_auth",params:{token:a,callback:c?c:!1},callback:function(a){litepubl.user=a;set_cookie("litepubl_user_id",a.id);set_cookie("litepubl_user",a.pass);
set_cookie("litepubl_regservice",a.regservice);e.registered=!0;e.logged=!0;b.isFunction(d)&&d("callback"in a?a.callback:void 0)}})},login:function(a,c,b){var e=this;e.open(a,function(a){e.auth(a,c,b)},b)},logon:function(a,c){var d=this;d.open("",function(b){d.auth(b,a,c)},function(){a?(a.callback=c,b.jsonrpc(a)):c()})},onlogin:function(a,c){if(!this.registered)return this.logon(a,c);var d=this;if(this.logged)if(a)a.callback=c,b.jsonrpc(a);else return c("logged"),!0;else b.jsonrpc({method:"check_logged",
params:{callback:a?a:!1},callback:function(b){"true"==b.result?(d.logged=!0,c("callback"in b?b.callback:void 0)):d.logon(a,c)}}),litepubl.stat("ulogin_checklogged");return!1}})})(jQuery,document,window);
