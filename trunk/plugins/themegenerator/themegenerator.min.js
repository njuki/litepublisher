...
function uploadProgress(a,b,d){set_progress(Math.ceil(100*(b/d)),this.customSettings.progress)}function uploadError(){set_progress(-1,this.customSettings.progress);alert("uploadError")}function uploadComplete(){set_progress(-1,this.customSettings.progress)}function uploadSuccess(a,b){set_color(this.customSettings.name,b)}
function createswfu(a){a={flash_url:ltoptions.files+"/js/swfupload/swfupload.swf",upload_url:document.location,post_params:{formtype:a?"headerurl":"logourl"},file_size_limit:a?"4 MB":"1 MB",file_types:a?"*.jpg;*.png;*.gif":"*.png",file_types_description:"Images",file_upload_limit:100,file_queue_limit:1,button_image_url:ltoptions.files+"/js/swfupload/images/XPButtonNoText_160x22.png",button_text:'<span class="upload_button">'+(a?lang.themegenerator.upload_header:lang.themegenerator.upload_logo)+"</span>",
