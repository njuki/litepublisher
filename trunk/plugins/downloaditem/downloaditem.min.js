(function(b){b(document).ready(function(){var d=b("a[rel='theme'], a[rel='plugin']");if(d.length){d.each(function(){b(this).data("url",b(this).attr("href"))});var e=function(a,b){var d="itemtype="+b+"&url="+encodeURIComponent(a),k=-1==ltoptions.download_site.indexOf("?")?"?":"&";return ltoptions.download_site+"/admin/service/upload/"+k+d},g=function(a){b.litedialog({title:ltoptions.siteurl_dialog.title,html:ltoptions.siteurl_dialog.html,buttons:[{title:"Ok",click:function(){var c=b.trim(b("input[name='text_download_site']").val());
