...
a.cookies[b]);e.location=a.posturl},submit:function(){try{if(!this.validate())return!1;if(this.options.confirmcomment)return this.send(),!1}catch(a){alert(a.message)}}});b(f).ready(function(){litepubl.confirmcomment=new litepubl.class_confirmcomment})})(jQuery,document,window);
