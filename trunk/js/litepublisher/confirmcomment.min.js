...
a.cookies[b]);window.location=a.posturl},submit:function(){try{if(!c.validate())return!1;d.confirmcomment&&c.send()}catch(a){alert(a.message)}return!1}};b(d.editor).off("keydown.confirmcomment").on("keydown.confirmcomment",function(a){a.ctrlKey&&(13==a.keyCode||10==a.keyCode)&&b(d.form).submit()});b(d.form).off("submit.confirmcomment").on("submit.confirmcomment",c.submit)};b(document).ready(function(){b.confirmcomment()})})(jQuery);
