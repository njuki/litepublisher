...
this.button.replace(/%%id%%/g,e+c).replace(/%%title%%/g,b.buttons[c].title);1==h&&(f=f.replace(/%%btn-default%%/g,"btn-primary"));var g=a.simpletml(this.tml,{id:g,title:b.title,body:b.html,buttons:f}),d=a(g).appendTo("body");this.dialog=d;c=0;for(h=b.buttons.length;c<h;c++)a("#"+e+c,d).data("index",c).on("click.dialog",b.buttons[c].click);if(a.isFunction(b.open))d.on("shown.bs.modal",function(){b.open(d)});d.modal();var k=this;d.on("hidden.bs.modal",function(){a.isFunction(b.close)&&b.close(d);k.dialog=
!1;d.remove()});return d}});ready2(function(){"modal"in a.fn&&(a.bootstrapDialog=new a.BootstrapDialog)})})(jQuery,window,document);
