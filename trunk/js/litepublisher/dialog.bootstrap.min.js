...
init:function(){this.id=a.now();this.stack=[];var e=this;this.options={title:"",html:"",width:300,open:a.noop,close:a.noop,buttons:[{title:"Ok",click:function(){e.close()}}]};a.closedialog=a.proxy(this.close,this);a.litedialog=a.proxy(this.open,this)},close:function(){if(!this.stack.length)return!1;this.stack.pop().modal("hide")},remove:function(a){for(var c=this.stack,b=c.length-1;0<=b;b--)if(a==c[b]){c.splice(b,1);a.remove();break}},open:function(e){for(var c=this.id++,b=a.extend({},this.options,
e),f="",e="button-"+c+"-",d=0,g=b.buttons.length;d<g;d++)f+=this.button.replace(/%%id%%/g,e+d).replace(/%%title%%/g,b.buttons[d].title);1==g&&(f=f.replace(/%%btn-default%%/g,"btn-primary"));c=a.simpletml(this.tml,{id:c,title:b.title,body:b.html,buttons:f});c=a(c).appendTo("body");d=0;for(g=b.buttons.length;d<g;d++)a("#"+e+d,c).data("index",d).on("click.dialog",b.buttons[d].click);this.stack.push(c);c.modal().on("shown.bs.modal",function(){a.isFunction(b.open)&&b.open(a(".pp_inline"))});var h=this;
c.on("hidden.bs.modal",function(){a.isFunction(b.close)&&b.close();h.remove(a(this))});return b}});a(h).ready(function(){"modal"in a.fn&&(a.bootstrapDialog=new a.BootstrapDialog)})})(jQuery,document);
