...
b.data("span");this.toggleicon(e);b.popover({title:e.text(),html:a.html,container:"body",placement:b.data("placement"),trigger:"manual"});d=this;b.on("click.widget",function(){var a=c(this);a.popover("toggle");d.toggleicon(a.data("span"));return!1})}},toggleicon:function(b){b.find("i").toggleClass(this.toggleclass)}});ready2(function(){"dropdown"in c.fn&&(f.widgets=new f.BootstrapWidgets)})})(jQuery,window,document,litepubl);
