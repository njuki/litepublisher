...
joinitems:function(b){for(var a in b)this.items[a]=b[a]},uploaded:function(c,a){try{var d=b.parseJSON(a),e=d.id;b.fileman.curr.push(e);b.fileman.items[e]=d.item;0!=d.item.preview&&(b.fileman.items[d.preview.id]=d.preview);b("#current-files .file-items").append(b.fileman.get_fileitem(e));b("#new-files .file-items").append(b.fileman.get_fileitem(e))}catch(f){alert("error "+f.message)}},setborders:function(c){var a=b(".file-item",c);if(0!=a.length){a.removeClass("border-left");var d=b(".file-item:first",
c).position();a.each(function(){var a=b(this);a.position().left==d.left&&a.addClass("border-left")})}},add:function(c){0<=b.inArray(c,this.curr)||(this.curr.push(c),this.setborders(b("#current-files .file-items").append(this.get_fileitem(c))))},del:function(c,a){var d=b.inArray(c,this.curr);0>d||(delete this.curr[d],d=a.parent(),a.remove(),this.setborders(d))},editprops:function(c,a){if(this.indialog)return!1;this.indialog=!0;var d=this.items[c];b.prettyPhotoDialog({title:lang.posteditor.property,
html:this.templates.fileprops,open:function(a){b("input[name='fileprop-title']",a).val(d.title);b("input[name='fileprop-description']",a).val(d.description);b("input[name='fileprop-keywords']",a).val(d.keywords)},buttons:[{title:"Ok",click:function(){var d=b(".pp_inline"),f=b.trim(b("input[name='fileprop-title']",d).val()),g=b.trim(b("input[name='fileprop-description']",d).val()),d=b.trim(b("input[name='fileprop-keywords']",d).val());b.prettyPhoto.close();b.fileman.setprops(c,f,g,d,a)}},{title:lang.dialog.cancel,
click:function(){b.prettyPhoto.close();b.fileman.indialog=!1}}]})},setprops:function(c,a,d,e,f){b.litejsontype("post",{method:"files_setprops",idfile:c,title:a,description:d,keywords:e},function(a){b.fileman.items[a.item.id]=a.item;f.replaceWith(b.fileman.get_fileitem(c));b.fileman.indialog=!1}).fail(function(a){b.fileman.indialog=!1;b.messagebox(lang.dialog.error,a.responseText)})}}})(jQuery);
