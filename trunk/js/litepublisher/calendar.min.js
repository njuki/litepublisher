...
changeYear:!0})},buttons:[{title:lang.dialog.close,click:function(){a.prettyPhoto.close()}}]})})}}});a(d).ready(function(){try{litepubl.calendar=new litepubl.Calendar}catch(a){erralert(a)}})})(jQuery,document,window);
