...
2)-20,d=Math.floor(c/4*3));e.width<=c&&e.height<=d?(c=e.width,d=e.height):c/d>f?c=Math.floor(d*f):d=Math.floor(c/f);var a=b.attr("title");n.test(a)&&(a=g.title);b.popover({container:"body",content:'<img src="'+l+'" width="'+c+'" height="'+d+'" />',delay:120,html:!0,placement:"auto "+(1<=f?"bottom":"right"),template:'<div class="popover popover-image"><div class="arrow"></div><h3 class="popover-title" style="max-width:'+c+'px;"></h3><div class="popover-content"></div></div>',title:a,trigger:"hover focus"+
s});b.data("focused")&&b.trigger(b.data("focused"));if(f=b.data("nextlink"))q=new Image,q.src=f.data("image");if(f=h.data("prevlink"))r=new Image,r.src=f.data("image")};e.onerror=function(){};e.src=b.data("image");return!1})})};ready2(function(){"popover"in k.fn&&k("a.photo").popimage()})})(jQuery,window,document);
