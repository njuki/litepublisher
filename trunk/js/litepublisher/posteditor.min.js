...
e.length&&e.replaceWith(e.get(0).firstChild.nodeValue)}})},init_visual_link:function(b,c){a('<a href="#">'+c+"</a>").appendTo("#posteditor-visual").data("url",b).one("click",function(){a.load_script(a(this).data("url"));a("#posteditor-visual").remove();return!1})}});a(f).ready(function(){try{litepubl.posteditor=new litepubl.Posteditor}catch(a){alert("error "+a.message)}})})(jQuery,document,window);
