...
b.fn.replaceComment=function(a){a=void 0==a?b(this.get(0).nodeValue):b(a);b(this).before(a).remove();return a};b.fn.findcomment=function(a){var b=!1,d=this.get(0);a&&(a="widgetcontent-"+a);do for(b=d;b=b.nextSibling;)if(8==b.nodeType&&(!a||a==b.nodeValue))return b;while(d=d.parentNode);return!1}})(jQuery,document,window);
