...
a&&b()})};a.fn.prettyPhotoDialog=function(b){a.prettyPhotoDialog({title:a(this).attr("title"),html:a(this).html(),buttons:b});return this};a.prettyPhotoDialog=function(b){for(var c=a.extend({title:"",html:"",width:300,open:a.noop,close:a.noop,buttons:[{title:"Ok",click:function(){a.prettyPhoto.close()}}]},b),b="",d=0,e=c.buttons.length;d<e;d++)b+='<button type="button" class="pp_dialog_btn_{index}">{title}</button>'.replace(/{index}/g,d).replace(/{title}/g,c.buttons[d].title);var d="pp_dialog_id_"+
(Math.random()+"").replace(".",""),f=a('<div CLASS="HIDDEN" id="'+d+'"></div>').appendTo("body");f.html('<div class="pp_dialog_title"><h3>'+c.title+"</h3></div>"+c.html+'<div class="pp_dialog_buttons">'+b+"</div>");b=a("<div></div>").appendTo("body").hide();e=a("<a title=''></a>").appendTo(b);e.attr("href","#"+d);e.prettyPhoto({default_width:c.width,opacity:0.6,modal:!0,deeplinking:!1,keyboard_shortcuts:!1,show_title:!1,social_tools:!1,changepicturecallback:function(){f.remove();a(".pp_close").remove();
