...
isWindow:b,isDocument:c,offset:a.offset()||{left:0,top:0},scrollLeft:a.scrollLeft(),scrollTop:a.scrollTop(),width:b||c?a.width():a.outerWidth(),height:b||c?a.height():a.outerHeight()}}};d.fn.position=function(a){if(!a||!a.of)return G.apply(this,arguments);a=d.extend({},a);var b,c,g,l,f,e,p=d(a.of),m=d.position.getWithinInfo(a.within),k=d.position.getScrollInfo(m),x=(a.collision||"flip").split(" "),q={};e=F(p);p[0].preventDefault&&(a.at="left top");c=e.width;g=e.height;l=e.offset;f=d.extend({},l);
...
b[0];f.top+=b[1];return this.each(function(){var e,u,r=d(this),s=r.outerWidth(),t=r.outerHeight(),v=parseInt(d.css(this,"marginLeft"),10)||0,w=parseInt(d.css(this,"marginTop"),10)||0,z=s+v+(parseInt(d.css(this,"marginRight"),10)||0)+k.width,A=t+w+(parseInt(d.css(this,"marginBottom"),10)||0)+k.height,h=d.extend({},f),B=C(q.my,r.outerWidth(),r.outerHeight());"right"===a.my[0]?h.left-=s:"center"===a.my[0]&&(h.left-=s/2);"bottom"===a.my[1]?h.top-=t:"center"===a.my[1]&&(h.top-=t/2);h.left+=B[0];h.top+=
B[1];D||(h.left=E(h.left),h.top=E(h.top));e={marginLeft:v,marginTop:w};d.each(["left","top"],function(f,l){if(d.ui.position[x[f]])d.ui.position[x[f]][l](h,{targetWidth:c,targetHeight:g,elemWidth:s,elemHeight:t,collisionPosition:e,collisionWidth:z,collisionHeight:A,offset:[b[0]+B[0],b[1]+B[1]],my:a.my,at:a.at,within:m,elem:r})});a.using&&(u=function(b){var d=l.left-h.left,e=d+c-s,f=l.top-h.top,m=f+g-t,k={target:{element:p,left:l.left,top:l.top,width:c,height:g},element:{element:r,left:h.left,top:h.top,
