...
_valueMax:function(){return this.max},_refreshValue:function(){var a,b,c,e,f,k=this.options.range,g=this.options,h=this,l=this._animateOff?!1:g.animate,m={};if(this.options.values&&this.options.values.length)this.handles.each(function(c){b=(h.values(c)-h._valueMin())/(h._valueMax()-h._valueMin())*100;m["horizontal"===h.orientation?"left":"bottom"]=b+"%";d(this).stop(1,1)[l?"animate":"css"](m,g.animate);if(!0===h.options.range)if("horizontal"===h.orientation){if(0===c)h.range.stop(1,1)[l?"animate":
"css"]({left:b+"%"},g.animate);if(1===c)h.range[l?"animate":"css"]({width:b-a+"%"},{queue:!1,duration:g.animate})}else{if(0===c)h.range.stop(1,1)[l?"animate":"css"]({bottom:b+"%"},g.animate);if(1===c)h.range[l?"animate":"css"]({height:b-a+"%"},{queue:!1,duration:g.animate})}a=b});else{c=this.value();e=this._valueMin();f=this._valueMax();b=f!==e?(c-e)/(f-e)*100:0;m["horizontal"===this.orientation?"left":"bottom"]=b+"%";this.handle.stop(1,1)[l?"animate":"css"](m,g.animate);if("min"===k&&"horizontal"===
this.orientation)this.range.stop(1,1)[l?"animate":"css"]({width:b+"%"},g.animate);if("max"===k&&"horizontal"===this.orientation)this.range[l?"animate":"css"]({width:100-b+"%"},{queue:!1,duration:g.animate});if("min"===k&&"vertical"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({height:b+"%"},g.animate);if("max"===k&&"vertical"===this.orientation)this.range[l?"animate":"css"]({height:100-b+"%"},{queue:!1,duration:g.animate})}},_handleEvents:{keydown:function(a){var b,c,e,f=d(a.target).data("ui-slider-handle-index");
...
c)},keyup:function(a){var b=d(a.target).data("ui-slider-handle-index");this._keySliding&&(this._keySliding=!1,this._stop(a,b),this._change(a,b),d(a.target).removeClass("ui-state-active"))}}})});
