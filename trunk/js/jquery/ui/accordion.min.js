(function(c){"function"===typeof define&&define.amd?define(["jquery","./core","./widget"],c):c(jQuery)})(function(c){return c.widget("ui.accordion",{version:"1.11.3",options:{active:0,animate:{},collapsible:!1,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},
...
b.attr("aria-hidden","false").prev().attr({"aria-selected":"true","aria-expanded":"true",tabIndex:0})},_animate:function(a,b,c){var f,e,g,k=this,l=0,h=a.length&&(!b.length||a.index()<b.index()),m=this.options.animate||{},h=h&&m.down||m,n=function(){k._toggleComplete(c)};"number"===typeof h&&(g=h);"string"===typeof h&&(e=h);e=e||h.easing||m.easing;g=g||h.duration||m.duration;if(!b.length)return a.animate(this.showProps,g,e,n);if(!a.length)return b.animate(this.hideProps,g,e,n);f=a.show().outerHeight();
