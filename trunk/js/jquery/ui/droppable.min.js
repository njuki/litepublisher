(function(d){"function"===typeof define&&define.amd?define(["jquery","./core","./widget","./mouse","./draggable"],d):d(jQuery)})(function(d){d.widget("ui.droppable",{version:"1.11.1",widgetEventPrefix:"drop",options:{accept:"*",activeClass:!1,addClasses:!0,greedy:!1,hoverClass:!1,scope:"default",tolerance:"intersect",activate:null,deactivate:null,drop:null,out:null,over:null},_create:function(){var a,b=this.options,c=b.accept;this.isover=!1;this.isout=!0;this.accept=d.isFunction(c)?c:function(a){return a.is(c)};
...
b,c,d){if(!b.offset)return!1;var e=(a.positionAbs||a.position.absolute).left,f=(a.positionAbs||a.position.absolute).top,k=e+a.helperProportions.width,m=f+a.helperProportions.height,l=b.offset.left,g=b.offset.top,n=l+b.proportions().width,p=g+b.proportions().height;switch(c){case "fit":return l<=e&&k<=n&&g<=f&&m<=p;case "intersect":return l<e+a.helperProportions.width/2&&k-a.helperProportions.width/2<n&&g<f+a.helperProportions.height/2&&m-a.helperProportions.height/2<p;case "pointer":a=d.pageY;c=b.proportions().height;
...
!0,this["isout"===f?"isover":"isout"]=!1,this["isover"===f?"_over":"_out"].call(this,b),c&&"isout"===f&&(c.isout=!1,c.isover=!0,c._over.call(c,b)))}})},dragStop:function(a,b){a.element.parentsUntil("body").unbind("scroll.droppable");a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,b)}};return d.ui.droppable});
