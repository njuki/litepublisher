...
b.hasMozNativeFullScreen&&document.mozCancelFullScreen()});b.hasSemiNativeFullScreen&&d.match(/mac os x 10_5/i)&&(b.hasNativeFullScreen=!1,b.hasSemiNativeFullScreen=!1)}};mejs.MediaFeatures.init();
...
a.pluginPath+a.flashName+'" flashvars="'+d.join("&")+'" width="'+g+'" height="'+h+'" class="mejs-shim"></embed>';break;case "youtube":a=b.url.substr(b.url.lastIndexOf("=")+1);youtubeSettings={container:m,containerId:m.id,pluginMediaElement:k,pluginId:l,videoId:a,height:h,width:g};mejs.PluginDetector.hasPluginVersion("flash",[10,0,0])?mejs.YouTubeApi.createFlash(youtubeSettings):mejs.YouTubeApi.enqueueIframe(youtubeSettings);break;case "vimeo":k.vimeoid=b.url.substr(b.url.lastIndexOf("/")+1),m.innerHTML=
'<iframe src="http://player.vimeo.com/video/'+k.vimeoid+'?portrait=0&byline=0&title=0" width="'+g+'" height="'+h+'" frameborder="0" class="mejs-shim"></iframe>'}c.style.display="none";c.removeAttribute("autoplay");return k},updateNative:function(b,a,c,d){b=b.htmlMediaElement;for(var e in mejs.HtmlMediaElement)b[e]=mejs.HtmlMediaElement[e];a.success(b,b);return b}};
...
(function(b,a,c){var d={locale:{language:"",strings:{}},methods:{}};d.locale.getLanguage=function(){return d.locale.language||navigator.language};"undefined"!=typeof mejsL10n&&(d.locale.language=mejsL10n.language);d.locale.INIT_LANGUAGE=d.locale.getLanguage();d.methods.checkPlain=function(a){var c,b,d={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};a=String(a);for(c in d)d.hasOwnProperty(c)&&(b=RegExp(c,"g"),a=a.replace(b,d[c]));return a};d.methods.formatString=function(a,c){for(var b in c){switch(b.charAt(0)){case "@":c[b]=
d.methods.checkPlain(c[b]);break;case "!":break;default:c[b]='<em class="placeholder">'+d.methods.checkPlain(c[b])+"</em>"}a=a.replace(b,c[b])}return a};d.methods.t=function(a,c,b){d.locale.strings&&d.locale.strings[b.context]&&d.locale.strings[b.context][a]&&(a=d.locale.strings[b.context][a]);c&&(a=d.methods.formatString(a,c));return a};d.t=function(a,c,b){if("string"===typeof a&&0<a.length){var h=d.locale.getLanguage();b=b||{context:h};return d.methods.t(a,c,b)}throw{name:"InvalidArgumentException",
message:"First argument is either not a string or empty."};};a.i18n=d})(document,mejs);(function(b,a){"undefined"!=typeof mejsL10n&&(b[mejsL10n.language]=mejsL10n.strings)})(mejs.i18n.locale.strings);"undefined"!=typeof jQuery?mejs.$=jQuery:"undefined"!=typeof ender&&(mejs.$=ender);
...
clickToPlayPause:!0,iPadUseNativeControls:!1,iPhoneUseNativeControls:!1,AndroidUseNativeControls:!1,features:"playpause current progress duration tracks volume fullscreen".split(" "),isVideo:!0,enableKeyboard:!0,pauseOtherPlayers:!0,keyActions:[{keys:[32,179],action:function(a,c){c.paused||c.ended?c.play():c.pause()}},{keys:[38],action:function(a,c){var b=Math.min(c.volume+0.1,1);c.setVolume(b)}},{keys:[40],action:function(a,c){var b=Math.max(c.volume-0.1,0);c.setVolume(b)}},{keys:[37,227],action:function(a,
...
"controls"),c.isiPad&&null!==a.media.getAttribute("autoplay")&&(a.media.load(),a.media.play())):c.isAndroid&&a.options.AndroidUseNativeControls||(a.$media.removeAttr("controls"),a.container=b('<div id="'+a.id+'" class="mejs-container '+(mejs.MediaFeatures.svg?"svg":"no-svg")+'"><div class="mejs-inner"><div class="mejs-mediaelement"></div><div class="mejs-layers"></div><div class="mejs-controls"></div><div class="mejs-clear"></div></div></div>').addClass(a.$media[0].className).insertBefore(a.$media),
a.container.addClass((c.isAndroid?"mejs-android ":"")+(c.isiOS?"mejs-ios ":"")+(c.isiPad?"mejs-ipad ":"")+(c.isiPhone?"mejs-iphone ":"")+(a.isVideo?"mejs-video ":"mejs-audio ")),c.isiOS?(c=a.$media.clone(),a.container.find(".mejs-mediaelement").append(c),a.$media.remove(),a.$node=a.$media=c,a.node=a.media=c[0]):a.container.find(".mejs-mediaelement").append(a.$media),a.controls=a.container.find(".mejs-controls"),a.layers=a.container.find(".mejs-layers"),c=a.isVideo?"video":"audio",e=c.substring(0,
1).toUpperCase()+c.substring(1),0<a.options[c+"Width"]||-1<a.options[c+"Width"].toString().indexOf("%")?a.width=a.options[c+"Width"]:""!==a.media.style.width&&null!==a.media.style.width?a.width=a.media.style.width:null!==a.media.getAttribute("width")?a.width=a.$media.attr("width"):a.width=a.options["default"+e+"Width"],0<a.options[c+"Height"]||-1<a.options[c+"Height"].toString().indexOf("%")?a.height=a.options[c+"Height"]:""!==a.media.style.height&&null!==a.media.style.height?a.height=a.media.style.height:
null!==a.$media[0].getAttribute("height")?a.height=a.$media.attr("height"):a.height=a.options["default"+e+"Height"],a.setPlayerSize(a.width,a.height),d.pluginWidth=a.width,d.pluginHeight=a.height);mejs.MediaElement(a.$media[0],d);"undefined"!=typeof a.container&&a.controlsAreVisible&&a.container.trigger("controlsshown")},showControls:function(a){var c=this;c.controlsAreVisible||("undefined"==typeof a||a?(c.controls.css("visibility","visible").stop(!0,!0).fadeIn(200,function(){c.controlsAreVisible=
...
controlsTimer:null,startControlsTimer:function(a){var c=this;a="undefined"!=typeof a?a:1500;c.killControlsTimer("start");c.controlsTimer=setTimeout(function(){c.hideControls();c.killControlsTimer("hide")},a)},killControlsTimer:function(a){null!==this.controlsTimer&&(clearTimeout(this.controlsTimer),delete this.controlsTimer,this.controlsTimer=null)},controlsEnabled:!0,disableControls:function(){this.killControlsTimer();this.hideControls(!1);this.controlsEnabled=!1},enableControls:function(){this.showControls(!1);
this.controlsEnabled=!0},meReady:function(a,c){var b=this,e=mejs.MediaFeatures,f=c.getAttribute("autoplay"),f=!("undefined"==typeof f||null===f||"false"===f),g;if(!b.created){b.created=!0;b.media=a;b.domNode=c;if(!(e.isAndroid&&b.options.AndroidUseNativeControls||e.isiPad&&b.options.iPadUseNativeControls||e.isiPhone&&b.options.iPhoneUseNativeControls)){b.buildposter(b,b.controls,b.layers,b.media);b.buildkeyboard(b,b.controls,b.layers,b.media);b.buildoverlays(b,b.controls,b.layers,b.media);b.findTracks();
for(g in b.options.features)if(e=b.options.features[g],b["build"+e])try{b["build"+e](b,b.controls,b.layers,b.media)}catch(h){}b.container.trigger("controlsready");b.setPlayerSize(b.width,b.height);b.setControlsSize();b.isVideo&&(mejs.MediaFeatures.hasTouch?b.$media.bind("touchstart",function(){b.controlsAreVisible?b.hideControls(!1):b.controlsEnabled&&b.showControls(!1)}):(mejs.MediaElementPlayer.prototype.clickToPlayPauseCallback=function(){b.options.clickToPlayPause&&(b.media.paused?b.media.play():
b.media.pause())},b.media.addEventListener("click",b.clickToPlayPauseCallback,!1),b.container.bind("mouseenter mouseover",function(){b.controlsEnabled&&!b.options.alwaysShowControls&&(b.killControlsTimer("enter"),b.showControls(),b.startControlsTimer(2500))}).bind("mousemove",function(){b.controlsEnabled&&(b.controlsAreVisible||b.showControls(),b.options.alwaysShowControls||b.startControlsTimer(2500))}).bind("mouseleave",function(){b.controlsEnabled&&(b.media.paused||b.options.alwaysShowControls||
b.startControlsTimer(1E3))})),b.options.hideVideoControlsOnLoad&&b.hideControls(!1),f&&!b.options.alwaysShowControls&&b.hideControls(),b.options.enableAutosize&&b.media.addEventListener("loadedmetadata",function(a){0>=b.options.videoHeight&&null===b.domNode.getAttribute("height")&&!isNaN(a.target.videoHeight)&&(b.setPlayerSize(a.target.videoWidth,a.target.videoHeight),b.setControlsSize(),b.media.setVideoSize(a.target.videoWidth,a.target.videoHeight))},!1));a.addEventListener("play",function(){for(var a in mejs.players){var c=
mejs.players[a];c.id==b.id||!b.options.pauseOtherPlayers||c.paused||c.ended||c.pause();c.hasFocus=!1}b.hasFocus=!0},!1);b.media.addEventListener("ended",function(a){if(b.options.autoRewind)try{b.media.setCurrentTime(0)}catch(c){}b.media.pause();b.setProgressRail&&b.setProgressRail();b.setCurrentRail&&b.setCurrentRail();b.options.loop?b.media.play():!b.options.alwaysShowControls&&b.controlsEnabled&&b.showControls()},!1);b.media.addEventListener("loadedmetadata",function(a){b.updateDuration&&b.updateDuration();
b.updateCurrent&&b.updateCurrent();b.isFullScreen||(b.setPlayerSize(b.width,b.height),b.setControlsSize())},!1);setTimeout(function(){b.setPlayerSize(b.width,b.height);b.setControlsSize()},50);b.globalBind("resize",function(){b.isFullScreen||mejs.MediaFeatures.hasTrueNativeFullScreen&&document.webkitIsFullScreen||b.setPlayerSize(b.width,b.height);b.setControlsSize()});"youtube"==b.media.pluginType&&b.container.find(".mejs-overlay-play").hide()}f&&"native"==a.pluginType&&(a.load(),a.play());if(b.options.success)if("string"==
typeof b.options.success)window[b.options.success](b.media,b.domNode,b);else b.options.success(b.media,b.domNode,b)}},handleError:function(a){this.controls.hide();this.options.error&&this.options.error(a)},setPlayerSize:function(a,c){"undefined"!=typeof a&&(this.width=a);"undefined"!=typeof c&&(this.height=c);if(0<this.height.toString().indexOf("%")||"100%"===this.$node.css("max-width")||1===parseInt(this.$node.css("max-width").replace(/px/,""),10)/this.$node.offsetParent().width()||this.$node[0].currentStyle&&
"100%"===this.$node[0].currentStyle.maxWidth){var d=this.isVideo?this.media.videoWidth&&0<this.media.videoWidth?this.media.videoWidth:this.options.defaultVideoWidth:this.options.defaultAudioWidth,e=this.isVideo?this.media.videoHeight&&0<this.media.videoHeight?this.media.videoHeight:this.options.defaultVideoHeight:this.options.defaultAudioHeight,f=this.container.parent().closest(":visible").width(),d=this.isVideo||!this.options.autosizeProgress?parseInt(f*e/d,10):e;"body"===this.container.parent()[0].tagName.toLowerCase()&&
