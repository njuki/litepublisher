...
a.enablePluginSmoothing&&d.push("smoothing=true");a.enablePseudoStreaming&&d.push("pseudostreaming=true");f&&d.push("controls=true");a.pluginVars&&(d=d.concat(a.pluginVars));switch(b.method){case "silverlight":m.innerHTML='<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="'+l+'" name="'+l+'" width="'+g+'" height="'+h+'" class="mejs-shim"><param name="initParams" value="'+d.join(",")+'" /><param name="windowless" value="true" /><param name="background" value="black" /><param name="minRuntimeVersion" value="3.0.0.0" /><param name="autoUpgrade" value="true" /><param name="source" value="'+
...
a+'" width="'+g+'" height="'+h+'" frameborder="0" class="mejs-shim" id="'+a+'"></iframe>',"function"==typeof $f){var p=$f(m.childNodes[0]);p.addEvent("ready",function(){function a(c,b,d,e){c={type:d,target:b};"timeupdate"==d&&(b.currentTime=c.currentTime=e.seconds,b.duration=c.duration=e.duration);b.dispatchEvent(c.type,c)}$.extend(p,{playVideo:function(){p.api("play")},stopVideo:function(){p.api("unload")},pauseVideo:function(){p.api("pause")},seekTo:function(a){p.api("seekTo",a)},setVolume:function(a){p.api("setVolume",
a)},setMuted:function(a){a?(p.lastVolume=p.api("getVolume"),p.api("setVolume",0)):(p.api("setVolume",p.lastVolume),delete p.lastVolume)}});p.addEvent("play",function(){a(p,k,"play");a(p,k,"playing")});p.addEvent("pause",function(){a(p,k,"pause")});p.addEvent("finish",function(){a(p,k,"ended")});p.addEvent("playProgress",function(c){a(p,k,"timeupdate",c)});k.pluginElement=m;k.pluginApi=p;mejs.MediaPluginBridge.initPlugin(l)})}else console.warn("You need to include froogaloop for vimeo to work")}c.style.display=
...
(function(b,a,c){var d={locale:{language:"",strings:{}},methods:{},getLanguage:function(){return(d.locale.language||window.navigator.userLanguage||window.navigator.language).substr(0,2).toLowerCase()}};"undefined"!=typeof mejsL10n&&(d.locale.language=mejsL10n.language);d.methods.checkPlain=function(a){var c,b,d={"&":"&amp;",'"':"&quot;","<":"&lt;",">":"&gt;"};a=String(a);for(c in d)d.hasOwnProperty(c)&&(b=new RegExp(c,"g"),a=a.replace(b,d[c]));return a};d.methods.t=function(a,c){d.locale.strings&&
d.locale.strings[c.context]&&d.locale.strings[c.context][a]&&(a=d.locale.strings[c.context][a]);return d.methods.checkPlain(a)};d.t=function(a,c){if("string"===typeof a&&0<a.length){var b=d.getLanguage();c=c||{context:b};return d.methods.t(a,c)}throw{name:"InvalidArgumentException",message:"First argument is either not a string or empty."};};a.i18n=d})(document,mejs);(function(b,a){"undefined"!=typeof mejsL10n&&(b[mejsL10n.language]=mejsL10n.strings)})(mejs.i18n.locale.strings);
...
c.controlsTimer=setTimeout(function(){c.hideControls();c.killControlsTimer("hide")},a)},killControlsTimer:function(a){null!==this.controlsTimer&&(clearTimeout(this.controlsTimer),delete this.controlsTimer,this.controlsTimer=null)},controlsEnabled:!0,disableControls:function(){this.killControlsTimer();this.hideControls(!1);this.controlsEnabled=!1},enableControls:function(){this.showControls(!1);this.controlsEnabled=!0},meReady:function(a,c){var b=this,e=mejs.MediaFeatures,f=c.getAttribute("autoplay"),
f=!("undefined"==typeof f||null===f||"false"===f),g;if(!b.created){b.created=!0;b.media=a;b.domNode=c;if(!(e.isAndroid&&b.options.AndroidUseNativeControls||e.isiPad&&b.options.iPadUseNativeControls||e.isiPhone&&b.options.iPhoneUseNativeControls)){b.buildposter(b,b.controls,b.layers,b.media);b.buildkeyboard(b,b.controls,b.layers,b.media);b.buildoverlays(b,b.controls,b.layers,b.media);b.findTracks();for(g in b.options.features)if(e=b.options.features[g],b["build"+e])try{b["build"+e](b,b.controls,b.layers,
b.media)}catch(h){}b.container.trigger("controlsready");b.setPlayerSize(b.width,b.height);b.setControlsSize();b.isVideo&&(mejs.MediaFeatures.hasTouch?b.$media.bind("touchstart",function(){b.controlsAreVisible?b.hideControls(!1):b.controlsEnabled&&b.showControls(!1)}):(b.clickToPlayPauseCallback=function(){b.options.clickToPlayPause&&(b.media.paused?b.play():b.pause())},b.media.addEventListener("click",b.clickToPlayPauseCallback,!1),b.container.bind("mouseenter mouseover",function(){b.controlsEnabled&&
!b.options.alwaysShowControls&&(b.killControlsTimer("enter"),b.showControls(),b.startControlsTimer(2500))}).bind("mousemove",function(){b.controlsEnabled&&(b.controlsAreVisible||b.showControls(),b.options.alwaysShowControls||b.startControlsTimer(2500))}).bind("mouseleave",function(){b.controlsEnabled&&(b.media.paused||b.options.alwaysShowControls||b.startControlsTimer(1E3))})),b.options.hideVideoControlsOnLoad&&b.hideControls(!1),f&&!b.options.alwaysShowControls&&b.hideControls(),b.options.enableAutosize&&
b.media.addEventListener("loadedmetadata",function(a){0>=b.options.videoHeight&&null===b.domNode.getAttribute("height")&&!isNaN(a.target.videoHeight)&&(b.setPlayerSize(a.target.videoWidth,a.target.videoHeight),b.setControlsSize(),b.media.setVideoSize(a.target.videoWidth,a.target.videoHeight))},!1));a.addEventListener("play",function(){for(var a in mejs.players){var c=mejs.players[a];c.id==b.id||!b.options.pauseOtherPlayers||c.paused||c.ended||c.pause();c.hasFocus=!1}b.hasFocus=!0},!1);b.media.addEventListener("ended",
function(a){if(b.options.autoRewind)try{b.media.setCurrentTime(0)}catch(c){}b.media.pause();b.setProgressRail&&b.setProgressRail();b.setCurrentRail&&b.setCurrentRail();b.options.loop?b.play():!b.options.alwaysShowControls&&b.controlsEnabled&&b.showControls()},!1);b.media.addEventListener("loadedmetadata",function(a){b.updateDuration&&b.updateDuration();b.updateCurrent&&b.updateCurrent();b.isFullScreen||(b.setPlayerSize(b.width,b.height),b.setControlsSize())},!1);setTimeout(function(){b.setPlayerSize(b.width,
b.height);b.setControlsSize()},50);b.globalBind("resize",function(){b.isFullScreen||mejs.MediaFeatures.hasTrueNativeFullScreen&&document.webkitIsFullScreen||b.setPlayerSize(b.width,b.height);b.setControlsSize()});"youtube"==b.media.pluginType&&b.options.autoplay&&b.container.find(".mejs-overlay-play").hide()}f&&"native"==a.pluginType&&b.play();if(b.options.success)if("string"==typeof b.options.success)window[b.options.success](b.media,b.domNode,b);else b.options.success(b.media,b.domNode,b)}},handleError:function(a){this.controls.hide();
...
g=f.find(".mejs-overlay-button");f.height(this.container.height()-this.controls.height());g.css("margin-top","-"+(g.height()/2-this.controls.height()/2).toString()+"px")},setControlsSize:function(){var a=0,c=0,d=this.controls.find(".mejs-time-rail"),e=this.controls.find(".mejs-time-total");this.controls.find(".mejs-time-current");this.controls.find(".mejs-time-loaded");var f=d.siblings(),g=f.last(),h=null;if(this.container.is(":visible")&&d.length&&d.is(":visible")){this.options&&!this.options.autosizeProgress&&
(c=parseInt(d.css("width")));0!==c&&c||(f.each(function(){var c=b(this);"absolute"!=c.css("position")&&c.is(":visible")&&(a+=b(this).outerWidth(!0))}),c=this.controls.width()-a-(d.outerWidth(!0)-d.width()));do d.width(c),e.width(c-(e.outerWidth(!0)-e.width())),"absolute"!=g.css("position")&&(h=g.position(),c--);while(null!=h&&0<h.top&&0<c);this.setProgressRail&&this.setProgressRail();this.setCurrentRail&&this.setCurrentRail()}},buildposter:function(a,c,d,e){var f=b('<div class="mejs-poster mejs-layer"></div>').appendTo(d);
