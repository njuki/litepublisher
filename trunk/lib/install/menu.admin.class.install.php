...
function tadminmenusInstall($self) {
  $self->lock();
  $self->heads = '  <link type="text/css" href="$site.files/js/jquery/ui-$site.jqueryui_version/redmond/jquery-ui-$site.jqueryui_version.custom.min.css" rel="stylesheet" />
