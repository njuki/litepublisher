(function(c){"function"===typeof define&&define.amd?define(["jquery","./core","./widget"],c):c(jQuery)})(function(c){return c.widget("ui.accordion",{version:"1.11.2",options:{active:0,animate:{},collapsible:!1,event:"click",header:"> li > :first-child,> :not(li):even",heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},
...
tabIndex:0,"aria-expanded":"true"})},_animate:function(a,b,c){var f,e,g,k=this,l=0,h=a.length&&(!b.length||a.index()<b.index()),m=this.options.animate||{},h=h&&m.down||m,n=function(){k._toggleComplete(c)};"number"===typeof h&&(g=h);"string"===typeof h&&(e=h);e=e||h.easing||m.easing;g=g||h.duration||m.duration;if(!b.length)return a.animate(this.showProps,g,e,n);if(!a.length)return b.animate(this.hideProps,g,e,n);f=a.show().outerHeight();b.animate(this.hideProps,{duration:g,easing:e,step:function(a,
b){b.now=Math.round(a)}});a.hide().animate(this.showProps,{duration:g,easing:e,complete:n,step:function(a,c){c.now=Math.round(a);"height"!==c.prop?l+=c.now:"content"!==k.options.heightStyle&&(c.now=Math.round(f-b.outerHeight()-l),l=0)}})},_toggleComplete:function(a){var b=a.oldPanel;b.removeClass("ui-accordion-content-active").prev().removeClass("ui-corner-top").addClass("ui-corner-all");b.length&&(b.parent()[0].className=b.parent()[0].className);this._trigger("activate",null,a)}})});
