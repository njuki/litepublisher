...
function C(a,c){c=c||{};for(var d=c.tags||l.tags,e=d[0],b=d[d.length-1],f=['var buffer = "";',"\nvar line = 1;","\ntry {",'\nbuffer += "'],g=[],k=!1,n=!1,u=function(){if(!k||n||c.space)g=[];else for(;g.length;)f.splice(g.pop(),1);n=k=!1},q=[],y,s,t,z=function(a){d=r(a).split(/\s+/);s=d[0];t=d[d.length-1]},A=function(a){f.push('";',y,'\nvar partial = partials["'+r(a)+'"];',"\nif (partial) {","\n  buffer += render(partial,stack[stack.length - 1],partials);","\n}",'\nbuffer += "')},x=function(b,d){var e=
