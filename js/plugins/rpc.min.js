...
new XMLHttpRequest;else if(window.ActiveXObject)try{h=new ActiveXObject("Msxml2.XMLHTTP")}catch(s){h=new ActiveXObject("Microsoft.XMLHTTP")}h.open("POST",this.__serviceURL,this.__isAsynchronous,this.__authUsername,this.__authPassword);"XML-RPC"==this.__protocol?(h.setRequestHeader("Content-Type","text/xml"),h.setRequestHeader("Accept","text/xml")):(h.setRequestHeader("Content-Type","application/json"),h.setRequestHeader("Accept","application/json"));if(this.__isAsynchronous){h.send(p);var n=this,
