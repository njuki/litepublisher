...
function widget_inline(b){var a=widget_findcomment(b,!1);if(!a)return alert("Widget not found");widget_add(b,$(a).replaceComment())}function widget_add(b,a){$(b).data("litepublisher_widget",a);$(b).click(function(a){widget_toggle(this);return!1})}function widget_toggle(b){$(b).data("litepublisher_widget").slideToggle()}
