...
img_html:'<img src="%%url%%" class="img-galery" width="%%width%%" height="%%height%%" style="left:%%left%%px" alt="" />',loading_html:'<img src="" data-src="modal-galery-loading" class="hide img-galery" alt="" />',thumb_html:'<a href="#" class="thumbnail" data-index="%%index%%"><img src="%%url%%" /></a>',style_html:'<style type="text/css">.modal-galery{width:%%dlg_width%%px;height:%%dlg_height%%px}.modal-galery .modal-body{width:%%body_width%%px;height:%%body_height%%px}</style>',init:function(b){this.items=
...
style:c,loading:!1};this.dialog.images.length=b.length;this.init_social();var d=this;this.dialog.thumbnails.on("click.thumbnail",".thumbnail",function(){d.setindex(e(this).attr("data-index"));return!1});e(".player-button",this.dialog.footer).tooltip({container:"body",placement:"top"}).on("click.galery",function(){var a=e(this);switch(a.attr("data-action")){case "next":d.setindex(d.getindex()+1);break;case "back":d.setindex(d.getindex()-1);break;case "play":a.attr("disabled","disabled");a.parent().find("[data-action='stop']").removeAttr("disabled");
d.play();break;case "stop":a.attr("disabled","disabled"),a.parent().find("[data-action='play']").removeAttr("disabled"),d.stop()}return!1});this.dialog.body.on("click.prevnext","img",function(a){var b=e(this);a.pageX-b.offset().left<b.width()/2?(d.stop(),d.setindex(d.getindex()-1)):(d.stop(),d.setindex(d.getindex()+1));a.preventDefault()});a.on("shown.bs.modal",function(){d.opened=!0;d.onopen.fire()}).on("hide.bs.modal",e.proxy(this.doclose,this)).on("hidden.bs.modal",e.proxy(this.doclosed,this)).modal()},
init_social:function(){var b=this;if("poplike"in e.fn)this.dialog.footer.find(".social-button").poplike({network:function(){return e(this).attr("data-like")},url:function(){return b.geturl()},title:function(){return b.gettitle()},placement:"top",lang:this.lang});else this.dialog.footer.find(".social-button").tooltip({container:"body",placement:"top"}).on("click.like",function(){var a=b.getindex(),c=b.dialog.items[a],a=encodeURIComponent(location.href),d=encodeURIComponent(c.title),f=encodeURIComponent(c.url),
c=e(this);switch(c.attr("data-like")){case "facebook":a=b.facebook_appid?"https://www.facebook.com/dialog/feed?app_id="+b.facebook_appid+"&link="+a+"&name="+d+"&picture="+f+"&display=popup&redirect_uri="+b.facebook_closeurl:"https://www.facebook.com/sharer.php?u="+a+"&t="+d;break;case "twitter":a="https://twitter.com/share?lang="+b.lang+"&url="+a+"&text="+d;break;case "vk":a="http://vk.com/share.php?url="+a;break;case "ok":a="http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st._surl="+a+"&st.comments="+
d;break;default:return!1}if(c.is("a"))c.attr("href",a),c.attr("target","_blank");else return l.open(a,"_blank"),!1})},close:function(){if(!this.dialog||!this.opened)return!1;this.dialog.dialog.modal("hide")},doclose:function(){if(!this.dialog||!this.opened)return!1;this.opened=!1;this.stop();this.dialog.footer.find("button").each(function(){var b=e(this),a=b.data("bs.tooltip");a&&a.hide();(b=b.data("bs.popover"))&&b.hide()})},doclosed:function(){this.hash_enabled&&(location.hash="!"+this.dataname);
this.dialog.style.remove();this.dialog.style=!1;this.onclose.fire()},open:function(b,a){if(!b||b.error||this.opened)return!1;this.opened=!0;b.ready||b.error||this.load(b,!1);a||(a=this.getcuritems(b.group));if(this.dialog){var c=this.dialog;c.items=a;c.images=[];c.images.length=a.length;c.body.empty();c.thumbnails.html(this.getthumbnails(a));c.style=e(this.getstyle(a)).appendTo("head:first");c.index=-1;this.setindex(this.urlindex(b.url));c.dialog.modal("show")}else this.init_dialog(a),this.setindex(this.urlindex(b.url))},
getcuritems:function(b){for(var a=[],c=0,d=this.items.length;c<d;c++){var e=this.items[c];e.error||(e.group==b||!e.group&&b==this.dataname||!b&&e.group==this.dataname)&&a.push(e)}return a},getthumbnails:function(b){for(var a="",c=0,d=b.length;c<d;c++)a+=this.parse(this.thumb_html,{index:c,url:b[c].url});return a},geturl:function(){return this.dialog.items[this.dialog.index].url},gettitle:function(){return this.dialog.items[this.dialog.index].title},urlindex:function(b){for(var a=this.dialog.items,
c=0,d=a.length;c<d;c++)if(b==a[c].url)return c;return!1},getindex:function(){return this.dialog.index},setindex:function(b){var a=parseInt(b);b=this.dialog.items;0>a&&(a=this.circle?b.length-1:0);a>=b.length&&(a=this.circle?0:b.length-1);if(a==this.dialog.index)return!1;var c=this.dialog.index;this.onindex.fire(a,c);this.dialog.index=a;var d=b[a];if(d.ready)this.setimage(a,c);else{var e=this;this.load(d,function(){e.opened&&e.setimage(a,c)});setTimeout(function(){!d.ready&&e.opened&&e.showloading()},
60)}},setimage:function(b,a){this.hideloading();this.dialog.title.text(this.dialog.items[b].title);if(0<=a)this.deactivate(this.dialog.images[a]),this.activate(this.getimage(b),e.proxy(this.animated,this));else{var c=this.getimage(b);c&&c.removeClass("hide").addClass(this.activeclass)}this.hash_enabled&&this.sethash(b);this.preload();this.onimage.fire(b)},getimage:function(b){if(0>b||b>=this.dialog.items.length)return!1;var a=this.dialog.images[b];if(a)return a;var c=this.dialog.items[b];if(!c.ready)return!1;
var a=this.dialog.body,d=a.width(),f=d,g=this.dialog.body.height();if(c.width<=f&&c.height<=g)f=c.width,g=c.height;else{var h=c.width/c.height;f/g>h?f=Math.floor(g*h):g=Math.floor(f/h)}c=e.simpletml(this.img_html,{url:c.url,width:f,height:g,left:Math.floor((d-f)/2)});return this.dialog.images[b]=e(c).appendTo(a)},deactivate:function(b,a){if(!b)return!1;b.removeClass(this.activeclass);e.support.transition?(b.removeClass(this.transclass),setTimeout(function(){b.addClass("hide")},this.speed)):b.stop(!0,
!0).fadeOut(this.speed,function(){e(this).addClass("hide")})},activate:function(b,a){if(!b)return!1;b.removeClass("hide").addClass(this.activeclass);e.support.transition?(b.addClass(this.transclass),a&&setTimeout(a,this.speed)):b.stop(!0,!0).fadeIn(this.speed,a)},preload:function(){for(var b=this.dialog.items,a=this.dialog.index+1,c=b.length;a<c;a++){var d=b[a];if(!d.ready&&!d.error){this.load(d,!1);break}}for(a=this.dialog.index-1;0<=a;a--)if(d=b[a],!d.ready&&!d.error){this.load(d,!1);break}},animated:function(){this.onanimated.fire();
this.opened&&this.playnext&&setTimeout(this.playnext,60)},playindex:function(){this.opened&&this.setindex(this.getindex()+1)},play:function(){if(1>=this.dialog.items.length)return!1;this.circle=!0;this.playnext=e.proxy(this.playindex,this);this.playnext()},stop:function(){this.playnext=this.circle=!1},showloading:function(){var b=this.dialog.loading;if(!b){var a=this.dialog.body,b=this.dialog.loading=e(this.loading_html).appendTo(a);if(b.is("img")&&!b.attr("src")){var c=b.attr("data-src");b.addClass(c);
b.attr("src",b.css("backgroundImage"));var d=b.css("width"),f=b.css("height");b.removeClass(c);b.css({width:d,height:f,left:Math.floor((a.width()-d)/2),top:Math.floor((a.height()-f)/2)})}else b.css({left:Math.floor((a.width()-b.width())/2),top:Math.floor((a.height()-b.height())/2)})}b.hasClass("hide")&&this.activate(b)},hideloading:function(){var b=this.dialog.loading;b&&!b.hasClass("hide")&&this.deactivate(b)}});e(g).ready(function(){e.litepublImages=new e.LitepublImages("a.photo")})})(jQuery,window,
document);
