...
a.button_text_top_padding=1,a.button_text_left_padding=5);try{this.onsettings(a),this.uploader=new SWFUpload(a)}catch(e){alert("Error create swfupload "+e.message)}}})})(jQuery,document,window);
