...
break;case "delete-toolbutton":g.del(b,a);break;case "property-toolbutton":g.editprops(b,a)}return!1});d.on("click.image","a.file-image",function(){g.openimage(c(this));return!1})},openimage:function(a){c.prettyPhoto.open(a.attr("href"),a.attr("title"),c("img",a).attr("alt"))},get_fileitem:function(a){var b=this.items[a];b.link=ltoptions.files+"/files/"+b.filename;type=b.media in this.tml?b.media:"file";b.previewlink="";0!=parseInt(b.preview)&&b.preview in this.items&&(b.previewlink=ltoptions.files+
"/files/"+this.items[b.preview].filename);b=c.simpletml(this.tml.item,{id:b.id,content:c.simpletml(this.tml[type],b)});return c(b).data("idfile",a)},loadpage:function(a,b){var d=this;c(a).data("files","loading");c.jsonrpc({type:"get",method:"files_getpage",params:{page:b-1},callback:function(b){d.joinitems(b.files);d.setpage(a,b.files)},error:function(a,b){c.messagebox(lang.dialog.error,a)}})},joinitems:function(a){for(var b in a)this.items[b]=a[b]},uploaded:function(a){try{var b=a.id;this.curr.push(b);
