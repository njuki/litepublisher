(function(a,h,k){a.BootstrapDialog=Class.extend({tml:'<div class="modal fade" id="dialog-%%id%%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">%%title%%</h4></div><div class="modal-body">%%body%%</div><div class="modal-footer">%%buttons%%</div></div></div></div>',button:'<button type="button" class="btn btn-default" id="%%id%%">%%title%%</button>',
...
this;c.on("hidden.bs.modal",function(){a.isFunction(b.close)&&b.close();h.remove(a(this))});return b}});a(k).ready(function(){h.setTimeout(function(){"modal"in a.fn&&(a.bootstrapDialog=new a.BootstrapDialog)},40)})})(jQuery,window,document);
