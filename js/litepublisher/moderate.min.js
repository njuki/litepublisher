...
a){var d=this,e=ltoptions.theme.comments,f=e.comment+c;switch(a){case "delete":case "del":this.setenabled(!1);b.confirmbox(lang.dialog.confirm,lang.comments.confirmdelete,lang.comments.yesdelete,lang.comments.nodelete,function(a){if(0!=a)return d.setenabled(!0);b.jsonrpc({type:"get",method:"comment_delete",params:{id:c},callback:function(a){if(!1==a)return d.error(lang.comments.notdeleted);b(f).remove();d.setenabled(!0)},error:function(a,b){d.error(lang.comments.notdeleted)}})});break;case "hold":case "approved":case "approve":this.setenabled(!1);
b.jsonrpc({type:"get",method:"comment_setstatus",params:{id:c,status:"hold"==a?"hold":"approved"},callback:function(g){try{if(!1==g)return d.error(lang.comments.notmoderated);b("hold"==a?e.hold:e.comments).append(b(e.comment+c));d.setenabled(!0)}catch(h){erralert(h)}},error:function(a,b){d.error(lang.comments.notmoderated)}});break;case "edit":this.setenabled(!1);b.jsonrpc({type:"get",method:"comment_getraw",params:{id:c},callback:function(a){try{d.edit(c,a.rawcontent)}catch(b){erralert(b)}},error:function(a,
