(function(b,f,g){litepubl.Posteditor=Class.extend({init:function(){var a=b("#tabs");if(0!=a.length){var c=this;a.tabs({hide:!0,show:!0,beforeLoad:litepubl.uibefore,beforeActivate:function(a,d){b("#datetime-holder",d.newPanel).length?c.init_datetime_tab(d.newPanel):b("#seo-holder",d.newPanel).length&&c.init_seo_tab(d.newPanel)},load:function(a,d){b(".posteditor-tag",d.panel).click(function(){c.addtag(b(this).text());return!1})}});b("#posteditor-init-raw-tabs").one("click",function(){c.init_raw_tabs();
...
c=a.get(0).firstChild.nodeValue;b(a.get(0).firstChild).remove();var c=c.replace(/<comment>/gim,'<div class="tab-holder">\x3c!--').replace(/<\/comment>/gim,"--\x3e</div>"),e=c.indexOf("<div");b("#posteditor-raw").before(c.substring(0,e)).after(c.substring(e));a.tabs({beforeLoad:litepubl.uibefore,beforeActivate:function(a,c){var e=b(".tab-holder",c.newPanel);e.length&&e.replaceWith(e.get(0).firstChild.nodeValue)}})},init_visual_link:function(a,c){b('<a href="#">'+c+"</a>").appendTo("#posteditor-visual").data("url",
