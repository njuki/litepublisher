...
"/js/jquery/ui-"+a.ui.version+"/jquery.ui.datepicker-"+ltoptions.lang+".min.js",b)})},init_raw_tabs:function(){a("#posteditor-init-raw-tabs").remove();var b=a("#posteditor-raw-holder"),c=b.get(0).firstChild.nodeValue;a(b.get(0).firstChild).remove();var c=c.replace(/<comment>/gim,'<div class="tab-holder"><\!--').replace(/<\/comment>/gim,"--\></div>"),e=c.indexOf("<div");a("#posteditor-raw").before(c.substring(0,e)).after(c.substring(e));b.tabs({cache:!0,select:function(b,c){var e=a(".tab-holder",c.panel);
