...
(Math.random()+"").replace(".",""),f=a('<div id="'+d+'"></div>').appendTo("body").hide();f.html('<div class="pp_dialog_title"><h3>'+c.title+"</h3></div>"+c.html+'<div class="pp_dialog_buttons">'+b+"</div>");b=a("<div></div>").appendTo("body").hide();e=a("<a title=''></a>").appendTo(b);e.attr("href","#"+d);e.prettyPhoto({default_width:c.width,opacity:0.6,modal:!0,deeplinking:!1,keyboard_shortcuts:!1,show_title:!1,social_tools:!1,changepicturecallback:function(){f.remove();a(".pp_close").remove();for(var b=
0,d=c.buttons.length;b<d;b++)a(".pp_dialog_btn_"+b).data("index",b).click(c.buttons[b].click);a(".pp_dialog_btn_0").focus();a.isFunction(c.open)&&c.open(a(".pp_inline"))},callback:function(){a(document).off("keydown.onEscape");a.isFunction(c.close)&&c.close()}});e.click();b.remove();a.onEscape(a.prettyPhoto.close);return c}})(jQuery);
